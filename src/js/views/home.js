...
export const Home = () => {
	...
	return (
		...
		<div className="conatiner m-auto">
			...
			<h1 className="text-center fs-1 bg-7 mt-2 text-warning"> <strong> Personajes</strong></h1>
			...
			<h1 className="text-center fs-1 bg-7 mt-2 text-warning"> <strong> Planetas</strong></h1>
			<div className=" row flex-nowrap overflow-auto border text-center border-warning m-4">
			...
			<h1 className="text-center fs-1 bg-7 mt-2 text-warning"> <strong> Vehiculos</strong></h1>
			<div className=" row flex-nowrap overflow-auto border text-center border-warning m-4">
				{store.vehicles.length > 0 ? store.vehicles.map((item) => <Vehicles key={item.uid} id={item.uid} nombre={item.name} ruta={"vehicles"} />) : null}
			</div>
